...
contains
   ...
   subroutine GiveNoErrorMessage(message)
      ...
      ! print *, "Subroutine GiveNoErrorMessage: Writing the message and no error to the terminal - WaveHello", message, NO_ERROR
   ...
   subroutine GiveErrorMessage(message)
      ...
      ! print *, "Subroutine GiverErrorMessage: Writing the message and error to the terminal- WaveHello", message, ERROR
   ...
   subroutine GiveWarningMessage(message)
      ...
      ! arguments:
      character*(*), intent(in) :: message
      ! print *, "Subroutine GiveWarningMessage, writing message and warning - WaveHello", message, WARNING
   ...
   subroutine CheckConditionWithError(condition, message, errorTypeInput)
      ...
      if (.not.condition) then
         ...
         ! print *, "Subroutine CheckCOnditionWithError writing message and errorType - WaveHello", message, errorType
...
subroutine Assert(condition, message)
   ...
   if (.not.condition) then
      print *, "Subroutine Assert - WaveHello", condition, message
