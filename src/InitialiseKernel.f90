...
module ModInitialiseKernel
  ...
  !  use ModErrorHandler!, only: GiveMessage
   use ModGetVersion, only: getVersion, getLastChangedDate, getLastCompiledDate  
   implicit none
...
contains
   ...
   subroutine ReadCommandLineParameters()
      ...
      ! TODO: Need to figure out what arguments I thinks it's reading
