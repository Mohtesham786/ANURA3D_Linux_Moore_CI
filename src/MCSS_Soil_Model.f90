...
module MOD_MCSS_ESM
   ...
   public ESM_MCSS ! Overides private status for specific subroutine

contains
   SUBROUTINE ESM_MCSS(NPT,NOEL,IDSET,STRESS,EUNLOADING,PLASTICMULTIPLIER,&
   ...
   SUBROUTINE UMAT_MohrCoulombStrainSoftening(STRESS, STATEV, DDSDDE, SSE, SPD, SCD, &
      ...
      ! 11 : YTOL    Yield surface tolerance
      ! 12 : num_integration_iters Max number of integration iterations allowed
      ! 13 : Euler_DT_min Minimum pseudo-time step for sloan integration
