    ...
    !*****************************************************************************
      ...
      implicit none
        ...
        character(len=64), parameter :: ESM_ARB_Model_MohrCoulombStrainSoftening = "ESM_MCSS"
...
! --- Generic entry points (call the wrapper routines below) ---
interface WriteVTKScalarDataPointer
  module procedure WriteVTKScalar_real
  module procedure WriteVTKScalar_int
end interface WriteVTKScalarDataPointer

interface WriteVTKVectorDataPointer
  module procedure WriteVTKVector_real
  module procedure WriteVTKVector_int
end interface WriteVTKVectorDataPointer

interface WriteVTKTensorDataPointer
  module procedure WriteVTKTensor_real
  module procedure WriteVTKTensor_int
end interface WriteVTKTensorDataPointer 
    
      contains
        ! ===== Wrappers for generic VTK calls (needed for ifx) =====

       subroutine WriteVTKScalar_real(DataSetName, DataSet)
        implicit none
        character(len=*), intent(in) :: DataSetName
        real(REAL_TYPE), dimension(:), intent(in) :: DataSet
        call WriteVTKFloatScalarDataPointer(DataSetName, DataSet)
       end subroutine WriteVTKScalar_real

       subroutine WriteVTKScalar_int(DataSetName, DataSet)
        implicit none
        character(len=*), intent(in) :: DataSetName
        integer(INTEGER_TYPE), dimension(:), intent(in) :: DataSet
        call WriteVTKIntegerScalarDataPointer(DataSetName, DataSet)
       end subroutine WriteVTKScalar_int


       subroutine WriteVTKVector_real(DataSetName, DataSet)
        implicit none
        character(len=*), intent(in) :: DataSetName
        real(REAL_TYPE), dimension(:,:), intent(in) :: DataSet
        call WriteVTKFloatVectorDataPointer(DataSetName, DataSet)
       end subroutine WriteVTKVector_real

      subroutine WriteVTKVector_int(DataSetName, DataSet)
       implicit none
       character(len=*), intent(in) :: DataSetName
       integer(INTEGER_TYPE), dimension(:,:), intent(in) :: DataSet
       call WriteVTKIntegerVectorDataPointer(DataSetName, DataSet)
      end subroutine WriteVTKVector_int


     subroutine WriteVTKTensor_real(DataSetName, DataSet)
      implicit none
      character(len=*), intent(in) :: DataSetName
      real(REAL_TYPE), dimension(:,:,:), intent(in) :: DataSet
      call WriteVTKFloatTensorDataPointer(DataSetName, DataSet)
     end subroutine WriteVTKTensor_real

     subroutine WriteVTKTensor_int(DataSetName, DataSet)
      implicit none
      character(len=*), intent(in) :: DataSetName
      integer(INTEGER_TYPE), dimension(:,:,:), intent(in) :: DataSet
      call WriteVTKIntegerTensorDataPointer(DataSetName, DataSet)
     end subroutine WriteVTKTensor_int
