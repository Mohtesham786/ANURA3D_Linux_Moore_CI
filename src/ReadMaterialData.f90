...
module ModReadMaterialData
   ...
   type MaterialParameterType
      ...
      character :: SoilModelDLLHandle ! This is handle to dll
            ...
            do I = 1, CalParams%NumberOfMaterials ! loop over number of materials
               ...
               select case (SelectConstitutiveModel) ! read constitutive model properties for solid or liquid
                ...
                case (ESM_LINEAR_ELASTICITY)
                  ...
                  !!!!!! Below code isn't going to work with linux
                  ! initialise DLL
                  ...
                  !TODO: Integrate Pietro's pointers into this call For the time being leave as string
                  MatParams(I)%SoilModelDLLHandle = ESM_LINEAR_ELASTICITY
                ...
                case (ESM_MOHR_COULOMB_STANDARD)
                  ...
                  MatParams(I)%SoilModelDLLHandle = ESM_MOHR_COULOMB_STANDARD
                ...
                case (ESM_MOHR_COULOMB_TEUNISSEN)
                  ...
                  MatParams(I)%SoilModelDLLHandle = ESM_MOHR_COULOMB_TEUNISSEN
                ...
                case (ESM_MOHR_COULOMB_STRAIN_SOFTENING)
                  ...
                  MatParams(I)%SoilModelDLLHandle = ESM_MOHR_COULOMB_STRAIN_SOFTENING
                ...
                case (ESM_MODIFIED_CAM_CLAY)
                  ...
                  MatParams(I)%SoilModelDLLHandle = ESM_MODIFIED_CAM_CLAY
               ...
               case (ESM_ARB_Model_MohrCoulombStrainSoftening)
                ...
                case (ESM_EXTERNAL_SOIL_MODEL)
                  ...
                  MatParams(I)%SoilModelDLLHandle = ESM_EXTERNAL_SOIL_MODEL
                ...
                case (ESM_BINGHAM_LIQUID)
                  ...
                  MatParams(I)%SoilModelDLLHandle = ESM_BINGHAM_LIQUID
